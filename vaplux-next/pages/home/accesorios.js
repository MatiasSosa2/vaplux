    ...
    <div>
      ...
      <header className="relative overflow-hidden bg-tech-navy noise-overlay">
        ...
        <div className="relative max-w-5xl mx-auto px-4 py-16">
          <span className="glass-badge">Accesorios</span>
          <h1 className="text-3xl sm:text-4xl font-bold tracking-wide text-white mt-3">Audio espacial, carga magnética y conectividad</h1>
          <p className="text-white/80 mt-2">Complementos esenciales para tu ecosistema.</p>
          <div className="mt-6 flex gap-3">
            <Link href="/catalog/varios" className="btn-cta btn-cta-primary">Ver Accesorios</Link>
      ...
      <section className="relative overflow-hidden bg-tech-white bg-grid noise-overlay">
        <div className="max-w-6xl mx-auto px-4 py-12">
          <h2 className="text-2xl font-bold">Destacados Accesorios</h2>
      ...
      <section className="relative overflow-hidden bg-tech-sky bg-grid noise-overlay">
        <div className="max-w-6xl mx-auto px-4 py-12">
          <h2 className="text-2xl font-bold">Novedades Accesorios</h2>
